...
function Profile() {
  ...
  const handleRemoveAllergy = async (indexToRemove) => {
    try {
      ...
      const userDocRef = doc(db, "Demographics", uid);
      await setDoc(userDocRef, { Allergies: updatedAllergies }, { merge: true });
  ...
  const handleRemoveChronicDisease = async (indexToRemove) => {
    try {
      const updatedChronicDiseases = chronicDiseases.filter((_, index) => index !== indexToRemove);
      setChronicDiseases(updatedChronicDiseases);
      
      const userDocRef = doc(db, "Demographics", uid);
      await setDoc(userDocRef, { ChronicDiseases: updatedChronicDiseases }, { merge: true });
  ...
  return (
    ...
    <div className="3xl:px-48 2xl:px-40 xl:px-32 lg:px-20 md:px-12 px-4 ">
      ...
      <div className="font-medium flex flex-col gap-2 mt-[5vh]  border px-5 rounded-sm  py-[5vh] m-4 ">
        ...
        <div className="">
          ...
          <input
            placeholder={weight1 ? weight1 : "weight(in kgs)"}
            className="py-1 md:py-2 pl-1.5 md:pl-3 border rounded-lg"
            type="number"
            aria-label="name"
        ...
        <div className="">
          ...
          <input
            placeholder={height1 ? height1 : "height(in cms)"}
            className="py-1 md:py-2 pl-1.5 md:pl-3 border rounded-lg"
            type="number"
            aria-label="name"
        ...
        <div className="">
          ...
          <input
            placeholder={gender1 ? gender1 : "gender"}
            className="py-1 md:py-2 pl-1.5 md:pl-3 border rounded-lg"
            aria-label="name"
        ...
        <button
          className="bg-black text-white mt-[5vh] w-[37vh] rounded-sm p-2 "
    ...
    <div>
      <div className="flex justify-content pt-[5vh] text-3xl  font-bold">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div
            ...
            } bg-gray-200 text-black rounded-lg shadow`}>
            <ul
              ...
              <li>
                <a
                  ...
                  onClick={() => handleAddChronicDisease("Asthma")}>
                Asthma
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  onClick={() => handleAddChronicDisease("Diabetes")}>
                  Diabetes
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  onClick={() => handleAddChronicDisease("Heart Disease")}>
                  Heart Disease
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white"
                  onClick={() => handleAddChronicDisease("Hypertension")}>
                  Hypertension
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:bg-gray-600 dark:hover:text-white"
                  onClick={() => handleAddChronicDisease("Arthritis")}>
               Arthritis
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  onClick={() => handleAddChronicDisease("Obesity")}>
                  Obesity
                </a>
              </li>
            </ul>
        ...
        {allergyToggle ? (
          <div>
            <input
              ...
              aria-label=""
              className="bg-gray-100 px-2 rounded-lg border py-1 md:py-2"
            />
          ...
          <div className="text-3xl font-bold cursor-pointer" onClick={handleAllergyToggle}>
            +
          </div>
        )}
        <div></div>
