            ...
            <div className='flex justify-content pt-[5vh] text-3xl gap-4 font-bold'>
                ...
                <div className='flex flex-col gap-1'>
                    <button
                        ...
                        className="text-3xl font-bold" type="button">+
                    </button>
                    <div id="dropdown" className={`z-10 ${dropdownVisible ? '' : 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
                        <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => handleAddChronicDisease('Diabetes')}>Diabetes</a>
                            </li>
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => handleAddChronicDisease('Heart Disease')}>Heart Disease</a>
                            </li>
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => handleAddChronicDisease('Hypertension')}>Hypertension</a>
                            </li>
                            <li>
                                <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => handleAddChronicDisease('Obesity')}>Obesity</a>
                            </li>
                        </ul>
                    </div>
                </div>
